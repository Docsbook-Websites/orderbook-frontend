---
title: "Migrating Bridge Config to an API-Driven Model"
description: "The plan to replace Orderbook Frontend's hardcoded bridge chains and tokens with a backend-served config, taking frontend deploys out of the loop."
---
