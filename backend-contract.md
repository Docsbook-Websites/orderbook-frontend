---
title: "Backend Contract: What OFE Expects"
description: "Understand exactly what the Orderbook Frontend expects from the GraphQL backend, the datafeed gateway, and the chain, to tell frontend bugs from backend ones."
---
